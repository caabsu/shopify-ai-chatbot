...
- Codex has Supabase MCP access and can create tables, run queries, manage the schema directly
...
- **Backend** → Railway (Codex has Railway MCP access for deployment, logs, domains)
- **Dashboard** → Vercel (Codex has Vercel MCP access — deferred to post-MVP)
