...
const services = [
  { name: 'DeepSeek V4', desc: 'V4 Flash/Pro routed through Vercel AI Gateway' },
...
export default function ChatbotCapabilitiesPage() {
  return (
    <div className="space-y-6">
      <h2 className="text-lg font-semibold" style={{ color: 'var(--text-primary)' }}>Capabilities</h2>
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>AI Tools ({tools.length})</h3>
        </div>
        <div className="space-y-3">
          {tools.map((t) => (
            <div key={t.name} className="flex items-start justify-between gap-4">
              <div>
                <code className="text-sm font-mono font-medium" style={{ color: 'var(--text-primary)' }}>{t.name}</code>
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>Shopify API Scopes</h3>
        </div>
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>Connected Services</h3>
        </div>
        <div className="space-y-3">
          {services.map((s) => (
            <div key={s.name}>
