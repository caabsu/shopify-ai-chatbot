// Default return email templates — used for auto-seeding when a brand doesn't have them yet.
// Mirrors the defaults in apps/backend/src/services/return-email-template.service.ts

export const ALL_RETURN_TEMPLATE_TYPES = [
  'confirmation',
  'approved',
  'approved_no_label',
  'approved_no_return',
...
export type ReturnTemplateType = (typeof ALL_RETURN_TEMPLATE_TYPES)[number];
...
export const DEFAULT_RETURN_EMAIL_TEMPLATES: Record<
  ReturnTemplateType,
